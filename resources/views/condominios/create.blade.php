...
<div class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1 class="m-0 text-dark">Registrar nuevo condominio</h1>
			</div><!-- /.col -->
			<div class="col-sm-6">
...
<section class="content">
	<div class="container-fluid">
		<div class="card card-primary">
			...
			<!-- /.card-header -->
			<!-- form start -->
			<form role="form" action="/condominios" method="post">
			{{ csrf_field() }}
			<div class="card-body">
					@if ($errors->any())
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="Nombre" placeholder="Nombre del condominio" value="{{ old('Nombre') }}">
							</div>
						</div>
					</div> <!-- /.row -->
				<!-- /.card-body -->
