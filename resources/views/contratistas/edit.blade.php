					...
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="coordinador" placeholder="Coordinador de atención técnica asignado" value="{{ old('coordinador', $contratista->coordinador) }}">
							</div>
						</div>
						<div class="col-sm-6">
