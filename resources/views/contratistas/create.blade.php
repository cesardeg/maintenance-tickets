					...
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="Empresa_contratista" placeholder="Empresa de contratista" value="{{ old('Empresa_contratista') }}">
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<label for="Nombre_responsable">Nombre del contratista responsable</label>
								<input type="text" class="form-control" name="Nombre_responsable" placeholder="Nombre del contratista responsable" value="{{ old('Nombre_responsable') }}">
							</div>
						</div>
            <div class="col-sm-6">
							<div class="form-group">
            ...
            <div class="col-sm-6">
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<div class="input-group date" id="fecha_producto_a_obra" data-target-input="nearest">
									<input type="text" name="Fecha_producto_a_obra" class="form-control datetimepicker-input" data-target="#fecha_producto_a_obra" value="{{ old('Fecha_producto_a_obra') }}"/>
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<div class="input-group date" id="fecha_producto_a_vivienda" data-target-input="nearest">
									<input type="text" name="Fecha_producto_a_vivienda" class="form-control datetimepicker-input" data-target="#fecha_producto_a_vivienda" value="{{ old('Fecha_producto_a_vivienda') }}"/>
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="Cat_asignado" placeholder="Coordinador de atención técnica asignado" value="{{ old('Cat_asignado') }}">
							</div>
						</div>
						<div class="col-sm-6">
						</div>
